...
//
		...
		times_equal_complex(&stap, GC->ztw[r][planeid(i,j)]);
...
//
		...
		times_equal_complex(&stap, GC->ztw[k][planeid(j,i)]);
...
//
	...
	times_equal_complex(&stap, C->ztw[r][planeid(i,j)]);
...
//
	...
	times_equal_complex(&stap, C->ztw[k][planeid(j,i)]);
...
//
		...
		factor*=GC->ztw[r][planeid(i,j)];
		times_equal_complex(&stap, factor); 
