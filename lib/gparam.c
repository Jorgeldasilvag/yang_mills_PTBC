...
void init_data_file(FILE **dataf, FILE **dataf_top0, FILE **dataf_top1, FILE **dataf_top2, FILE **dataf_top3, 
						FILE **chiprimef, FILE **topchar_tcorr_f, GParam const * const param)
{
	int i;
	...
	if(param->d_start==2)
	{
		...
		*dataf_top0=fopen("qtop0.dat", "r");
		if(*dataf_top0!=NULL) // file exists
		{
			fclose(*dataf_top0);
			*dataf_top0=fopen("qtop0.dat", "a");
		}
		else
		{
 			*dataf_top0=fopen("qtop0.dat", "w");
		fprintf(*dataf_top0, "\n");
		}

		*dataf_top1=fopen("qtop1.dat", "r");
		if(*dataf_top1!=NULL) // file exists
		{
			fclose(*dataf_top1);
			*dataf_top1=fopen("qtop1.dat", "a");
		}
		else
		{
 			*dataf_top1=fopen("qtop1.dat", "w");
		fprintf(*dataf_top1, "\n");
		}

		*dataf_top2=fopen("qtop2.dat", "r");
		if(*dataf_top2!=NULL) // file exists
		{
			fclose(*dataf_top2);
			*dataf_top2=fopen("qtop2.dat", "a");
		}
		else
		{
 			*dataf_top2=fopen("qtop2.dat", "w");
		fprintf(*dataf_top2, "\n");
		}

		*dataf_top3=fopen("qtop3.dat", "r");
		if(*dataf_top3!=NULL) // file exists
		{
			fclose(*dataf_top3);
			*dataf_top3=fopen("qtop3.dat", "a");
		}
		else
		{
 			*dataf_top3=fopen("qtop3.dat", "w");
		fprintf(*dataf_top3, "\n");
		}
